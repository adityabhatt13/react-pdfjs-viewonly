...
class PDFViewer {
  ...
  constructor(options) {
    ...
    this.#annotationEditorMode = false;
    this.#annotationEditorHighlightColors = false;
    this.#enableHighlightFloatingButton =
      options.enableHighlightFloatingButton === false;
    this.#enableUpdatedAddImage = options.enableUpdatedAddImage === false;
...
const PDFViewerApplication = {
  ...
  eventBus: null,
  l10n: null,
  annotationEditorParams: false, // aditya
